	...
	<section class="page-section categories-page">
		<div class="container">
			<div class="row">
				...
				<a href="{{ route('listing.details',$sale->id) }}">
					<div class="col-lg-4 col-md-6">
						<!-- feature -->
						<div class="feature-item">
							<div class="feature-pic set-bg" data-setbg="{{ asset('frontend/img/feature/1.jpg') }}">
								<div class="sale-notic">{{ $sale->property_type }}</div>
							</div>
							<div class="feature-text">
								<div class="text-center feature-title">
									<h5>{{ $sale['city']['name'] }}</h5>
									<p><i class="fa fa-map-marker"></i> {{ $sale->address }}</p>
								</div>
								<div class="room-info-warp">
									<div class="room-info">
										<div class="rf-left">
											<p><i class="fa fa-th-large"></i> {{ $sale->property_space }} Square foot</p>
											<p><i class="fa fa-bed"></i> {{ $sale->beds }} Bedrooms</p>
										</div>
										<div class="rf-right">
											<p><i class="fa fa-car"></i> 2 Garages</p>
											<p><i class="fa fa-bath"></i> {{ $sale->bathrooms }} Bathrooms</p>
										</div>	
									</div>
									<div class="room-info">
										<div class="rf-left">
										...
										<div class="rf-right">
											<p><i class="fa fa-clock-o"></i> {{ $sale->created_at->diffForHumans() }}</p>
										</div>	
									</div>
								</div>
								<a href="#" class="room-price">$ {{ $sale->price }}</a>
							</div>
						</div>
					</div>
				</a>
